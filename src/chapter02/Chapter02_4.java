...
public class Chapter02_4 {
	 ...
	 * </table>
	 * <br>
	 * 16비트로 표현할 수 있는 정수의 개수 : 2<sup>16</sup>개(65536개)<br>
	 * short타입의 표현범위 : -2<sup>16</sup> ~ 2<sup>15</sup> -1 (-32768 ~ 32767)<br>
	 * char타입의 표현범위 : 0 ~ 2<sup>16</sup> -1 (0 ~ 65535)
	 */
	class Memo12 {
	 ...
	 * 연산속도의 향상이나 메모리를 절약하려면 float를 선택하고, 더 큰 값의 범위라던가 더 높은 정밀도를 필요로 한다면 double을 선택해야 한다.<br>
	 */
	class Memo13 {
	 ...
	 * 'E'는 지수를 저장하는 부분으로 float의 경우, 8 bit의 저장공간을 갖는다. 지수는 '부호있는 정수'이고 8 bit로는 모두 2<sup>8</sup>(=256)개의 값을 저장할 수 있다.<br>
	 * '-127 ~ 128'의 값이 저장된다. -127과 128은 '숫자 아님(NaN, Not a Number)'이나 '양의 무한대(POSITIVE_INFINITY)', '음의 무한대(NEGATIVE_INFINITY)'와 같이 특별한 값의 표현을 위해 예약되어 있으므로,<br>
